...
public static Date getDateFromString(String dateString) {
    ...
    public static void main(String[] args) {
        ...
        //Pour afficher en triant par ordre croissant sur le nom et par ordre décroissant sur l'âge
        emp.getEmployes(emp.EmpCollectionName, 
        new Document(), 
        new Document(), 
        ...
        emp.getEmployes(emp.EmpCollectionName, whereQuery, projectionFields, sortFields);
