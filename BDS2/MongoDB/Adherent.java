...
public class Adherent {
    ...
    public String getAdherentCollectionName() {
        return this.AdhCollectionName;
    }
    ...
    // Method Overloading ! (adding a limit)
    public void getAdherent(String nomCollection,
            Document whereQuery,
            Document projectionFields,
            Document sortFields, int limit) {
        System.out.println("\n\n\n** dans getAdherent **");
    ...
    public void createSimpleIndex(String nomCollection, String field) {
        MongoCollection<Document> collection = database.getCollection(nomCollection);
        collection.createIndex(new Document(field, 1)); // 1 for ascending order
    }

    public void createCompoundIndex(String nomCollection, String field1, String field2) {
        MongoCollection<Document> collection = database.getCollection(nomCollection);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n***************************************");
        System.out.println("On projete sur nom et sur prenom (les 10 premiers seulement)");
        System.out.println("***************************************\n");
        adh.getAdherent(adh.AdhCollectionName,
                new Document(),
        ...
        System.out.println("\n***************************************");
        System.out.println("On affiche les informations sur l'adherent dont l'id est 450");
        System.out.println("***************************************\n");
        adh.getAdherent(adh.AdhCollectionName,
        ...
        System.out.println("\n***************************************");
        System.out.println(
                "On projete sur nom et prenom, on trie par ordre croissant les noms (les 10 premiers seulement)");
        System.out.println("***************************************\n");
        adh.getAdherent(adh.AdhCollectionName,
                new Document(),
                new Document("nom", 1).append("prenom", 1),
                new Document("nom", 1), 10);

        // On projete sur nom, date d'inscription. On trie par ordre decroisssant les
        // inscriptions
        System.out.println("\n***************************************");
        System.out.println(
                "On projete sur nom, date d'inscription. On trie par ordre decroisssant les inscriptions (les 10 premiers seulement)");
        System.out.println("***************************************\n");
        adh.getAdherent(adh.AdhCollectionName,
                new Document(),
                new Document("nom", 1).append("date_inscription", 1),
                new Document("date_inscription", -1), 10);

        adh.createSimpleIndex(adh.AdhCollectionName, "nom"); // Simple index on "nom" field

        adh.createCompoundIndex(adh.AdhCollectionName, "nom", "date_inscription"); // Compound index on "nom" and
                                                                                   // "date_inscription" fields
    }
}